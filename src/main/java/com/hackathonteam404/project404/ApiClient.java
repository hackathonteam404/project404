...
import com.hackathonteam404.project404.auth.Authentication;
import com.hackathonteam404.project404.auth.HttpBasicAuth;
import com.hackathonteam404.project404.auth.ApiKeyAuth;
import com.hackathonteam404.project404.auth.OAuth;
import com.hackathonteam404.project404.model.EncryptedResponse;
...
@Component("com.visa.developer.sample.merchant_locator_api.ApiClient")
public class ApiClient {
    ...
    public <T> T invokeAPI(String path, String resourcePath, HttpMethod method, MultiValueMap<String, String> queryParams, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, String[] authNames, ParameterizedTypeReference<T> returnType, Class<T> returnClassType) throws RestClientException {
        ...
        //  System.out.println("builder: " + queryParams.toString());
...
//      ResponseEntity<EncryptedResponse> responseEntity = restTemplate.exchange(requestEntity, encryptedResponseType);
        ...
        //System.out.println("res entity: " + responseEntity.toString());
    ...
    public MerchantLocatorpostResponse invokeAPI2(String path, String resourcePath, HttpMethod method, MultiValueMap<String, String> queryParams, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, String[] authNames) throws RestClientException {
        ...
        HttpEntity<MerchantLocatorpostPayload> request = new HttpEntity<MerchantLocatorpostPayload>((MerchantLocatorpostPayload) body, headerParams);


        ResponseEntity<MerchantLocatorpostResponse> responseEntity = restTemplate
                .exchange(builder.build().toUri(), HttpMethod.POST, request, MerchantLocatorpostResponse.class);
